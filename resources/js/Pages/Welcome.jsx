                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                            <div className="flex lg:col-start-2 lg:justify-center">
                                <div className="relative flex items-center justify-center text-[#1E293B]">
                                    <svg width="100" height="110" viewBox="0 0 90 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M45 5L82.27 24.5V75.5L45 95L7.73 75.5V24.5L45 5Z" fill="currentColor" stroke="#D4AF37" strokeWidth="2"/>
                                        <path d="M35 70V30H65" stroke="#F8FAFC" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"/>
                                        <path d="M35 50H55" stroke="#F8FAFC" strokeWidth="8" strokeLinecap="round"/>
                                        <path d="M60 30L68 22" stroke="#D4AF37" strokeWidth="6" strokeLinecap="round"/>
                                    </svg>
                                </div>
                            </div>
